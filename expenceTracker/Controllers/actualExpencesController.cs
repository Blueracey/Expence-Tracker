...
namespace expenceTracker.Controllers
{
    public class actualExpencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,finalCost,profileId,expenceID,category,datePayed")] actualExpence actualExpence)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,finalCost,profileId,expenceID,category,datePayed")] actualExpence actualExpence)
        {
